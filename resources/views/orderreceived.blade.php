		                            ...
		                            <table style='width: 50%;'>
		                                ...
		                                <tr>
		                                    <td align="center" colspan="2">
												<!-- <hr style='border-color: #fff;border: 0px; border-top: 1px solid aliceblue;'> -->
											</td>
		                                </tr>
		                            </tbody></table>
		                            <table class="" style='background: #fff; width: 70%; border-radius: 10px; box-shadow: 0px 5px 5px #2f83ac;'>
										...
										<tr>
		                                    <td align="center" colspan="2" valign="baseline">
		                                        <h2 style="margin-top: 0px;margin-bottom: 10px; font-size:30px;">Order Received</h2>
		                                    </td>
		                                </tr>
										<tr>
		                                    <td align="center" colspan="2">&nbsp;</td>
		                                    ...
		                                    <tr>
		                                        ...
		                                        <td style="width:60%;padding:2% 5% 2% 5%; font-weight: bold; font-size: 18px; color: #4b4b4b;">
                                                <span class=""><?php echo $companyn; ?></span>
		                                        </td>
		                                    </tr>
		                                    <tr>
		                                        <td style="width:40%;padding-left:10%">
		                                            <span class="">Quotation Name</span>
		                                        </td>
		                                        <td style="width:60%;padding:2% 5% 2% 5%; font-weight: bold; font-size: 18px; color: #4b4b4b;">
                                                    <span class=""><?php echo $quotename; ?></span>
		                                        </td>
		                                    </tr>
		                                    <tr>
		                                        <td style="width:40%;padding-left:10%">
		                                        ...
		                                        <td style="width:60%;padding:2% 5% 2% 5%; font-weight: bold; font-size: 18px; color: #4b4b4b;">
                                                    <span class=""><?php echo $paytitle; ?></span>
		                                        </td>
		                                    </tr>
                                            <tr>
		                                        <td style="width:40%;padding-left:10%">
		                                            <span class="">Signed by</span>
		                                        </td>
		                                        <td style="width:60%;padding:2% 5% 2% 5%; font-weight: bold; font-size: 18px; color: #4b4b4b;">
		                                    ...
		                                    <!-- <tr>
		                                        <td style="width:40%;padding-left:10%">
		                                            <span class="">Qoutation Link</span>
		                                        </td>
		                                        <td style="width:60%;padding:2% 5% 2% 5%; font-weight: bold; font-size: 18px; color: #4b4b4b;">
                                                    <span class=""> <a href='<?php // echo $link; ?>'> Our Offer </a> </span>
		                                        </td>
		                                    </tr> -->
		                                    <tr>
		                                        <td align="center" colspan="2">&nbsp;</td>
		                                    ...
		                                    <!-- <tr>
		                                        <td align="center" colspan="2"> 
													<a style="background: #3673ec;border: none;border-radius: 4px;padding: 3% 15%;font-size: 14px;color: #fff;"> Order </a> </td>
		                                    </tr> -->
		                                    <tr>
		                                        <td align="center" colspan="2">&nbsp;</td>
		                                    </tr>
